    ...
    */
    ...
    update: function (oldData) {
        if (this.data != this.oldData) {
            // Delete if exists
            if (this.cursor || this.leftHand || this.rightHand) {
                this.el.parentElement.removeChild(this.cursor)
                this.el.parentElement.removeChild(this.leftHand)
                this.el.parentElement.removeChild(this.rightHand)
