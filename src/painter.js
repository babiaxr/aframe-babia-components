window.onload = () => {
    ...
    document.getElementById("keyboard").addEventListener('superkeyboardinput', function (f) {
        // Add querier when insert username
        let username = f.target.components['super-keyboard'].data.value
        let querier = document.createElement('a-entity');
        querier.setAttribute('querier_github', 'user: ' + username);
        querier.setAttribute('id', 'queriertest');
        document.getElementById("AframeScene").appendChild(querier)
