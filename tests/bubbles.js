/*
 * Cypress test for babia-bubbles component
 */

describe ('babia-bubbles component', () => {
    ...
    it ('Simple Creation', () => {
        ...
        cy.get('a-scene').then(scene => {
            // Add components     
            let chart = Cypress.$('<a-entity babia-bubbles="legend: true; axis: true; data: '+ data + '" ></a-entity>');
            Cypress.$(scene).append(chart); //appendchild
        });
        
        // Test entities existence
        assert.exists(cy.get('a-entity[babia-bubbles]'));
        // Check attributes
        cy.get('a-entity[babia-bubbles]').invoke('attr', 'babia-bubbles')
    ...
    it ('Querier Creation', () => {
        cy.get('a-scene').then(scene => {
            ...
            let chart = Cypress.$('<a-entity babia-bubbles="legend: true; axis: true; from: queriertest; x_axis: name; z_axis: name2; height: size; radius: height"></a-entity>');
