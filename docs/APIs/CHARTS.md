...
| legend_lookat                 | Element that the legend will follow in terms of rotation                                                                                                                                     | string                 | `[camera]`    |
| legend_scale                  | Scale for the legend                                                                                                                                                                        | number                 | 1             |
| legend_text | Template for the text shown in legends. Supports dynamic placeholders to display field names and values. Use `\n` to insert new lines. <br><br>**Supported placeholders:**<br>• `{name}` – Name of the element.<br>• `{height}`, `{area}`, `{width}`, `{depth}`, `{color}` – Metric values based on fields defined in the component.<br>• `{fheight}`, `{farea}`, `{fwidth}`, `{fdepth}`, `{fcolor}` – Names of the fields used for each metric.<br>• `{any_field}` – Any other field present in the raw data can also be shown dynamically (e.g. `{loc}`, `{cc}`, `{author}`...).<br><br>**Tip:** When used on quarters (elements with children), only `{name}` is shown regardless of the template. | string | `{name}\n{fheight} (height): {height}\n{farea} (area): {area}\n{fwidth} (width): {width}\n{fdepth} (depth): {depth}\n{fcolor}: {color}` |
